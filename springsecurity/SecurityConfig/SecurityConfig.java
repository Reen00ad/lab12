...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity.csrf().disable()
                ...
                .requestMatchers("/api/v1/blog/getalla").hasAuthority("ADMIN")
                ...
                .requestMatchers("/api/v1/blog/get","/api/v1/blog/add","/api/v1/blog/update/{blogid}","/api/v1/blog/delete/{blogid}","/api/v1/blog/getBlogById/{blogid}","/api/v1/blog/getBlogByTitle/{blogtitle}").hasAuthority("CUSTOMER")
